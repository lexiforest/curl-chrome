...
const struct helptxt helptext[] = {
  ...
  { "    --http2",
    "Use HTTP/2",
    CURLHELP_HTTP },
  { "    --http2-pseudo-headers-order <list>",
    "Set HTTP/2 pseudo-header order",
    CURLHELP_HTTP },
  ...
  { "    --http2-window-update <value>",
    "Set initial HTTP/2 window update",
    CURLHELP_HTTP },
  { "    --http3",
    "Use HTTP/3",
    CURLHELP_HTTP },
  { "    --http3-curves <list>",
    "HTTP/3 TLS key exchange algorithms",
    CURLHELP_TLS },
  { "    --http3-httpheader <header/@file>",
    "Pass HTTP/3-specific header(s) to server",
    CURLHELP_HTTP },
  { "    --http3-httpheader-order <list>",
    "Set HTTP/3 header order",
    CURLHELP_HTTP },
  { "    --http3-only",
    "Use HTTP/3 only",
    CURLHELP_HTTP },
  { "    --http3-pseudo-headers-order <list>",
    "Set HTTP/3 pseudo-header order",
    CURLHELP_HTTP },
  { "    --http3-settings <list>",
    "Set HTTP/3 settings",
    CURLHELP_HTTP },
  { "    --http3-sig-hash-algs <list>",
    "Set HTTP/3 TLS signature algorithms",
    CURLHELP_TLS },
  { "    --http3-tls-extension-order <list>",
    "Set HTTP/3 TLS extension order",
    CURLHELP_TLS },
  { "    --http3-permute-extensions",
    "Permute HTTP3 TLS extensions in ClientHello",
    CURLHELP_TLS },
  ...
  { "    --no-sessionid",
    ...
    CURLHELP_TLS },
  { "    --no-split-cookies",
    "Merge cookies into one Cookie header",
    CURLHELP_HTTP },
  ...
  { "    --proxy-credential-no-reuse",
    "Do not reuse connections across proxy credentials",
    CURLHELP_PROXY | CURLHELP_TLS },
  { "    --proxy-crlfile <file>",
  ...
  { "    --split-cookies",
    "Send separate Cookie header lines",
    CURLHELP_HTTP },
  { "    --socks4 <host[:port]>",
  ...
  { "    --tls-permute-extensions",
    "Permute TLS extensions in ClientHello",
    CURLHELP_TLS },
  { "    --tls13-ciphers <list>",
  ...
  { "-w, --write-out <format>",
    ...
    CURLHELP_VERBOSE },
  { "    --ws-cert-compression <list>",
    "WebSocket TLS certificate compression",
    CURLHELP_TLS },
  { "    --ws-disable-session-ticket",
    "Disable WebSocket TLS session tickets",
    CURLHELP_TLS },
  { "    --ws-httpheader <header/@file>",
    "Pass WebSocket-specific header(s) to server",
    CURLHELP_HTTP },
  { "    --ws-httpheader-order <list>",
    "Set WebSocket header order",
    CURLHELP_HTTP },
  { "    --xattr",

...
const struct helptxt helptext[] = {
  ...
  {"    --http2-pseudo-headers-order",
   ...
   CURLHELP_HTTP},
  {"    --http-header-order <headers>",
   "Change the order of HTTP request headers",
   CURLHELP_HTTP},
  {"    --http2-settings",
  ...
  {"    --http3-httpheader-order <list>",
   "Change the order of HTTP/3 headers",
   CURLHELP_HTTP},
  {"    --http3-curves <list>",
   "HTTP/3 TLS key exchange algorithms to request",
   CURLHELP_TLS},
  {"    --http3-settings",
   "Change the order/values of the HTTP3 settings frame, e.g. 1:0;6:4611686018427387903;7:0;GREASE",
   CURLHELP_HTTP},
  {"    --http3-sig-hash-algs",
   "Signature hash algorithms for HTTP/3 (QUIC TLS), overrides --ssl-sig-hash-algs for QUIC",
   CURLHELP_TLS},
  ...
  {"    --ws-httpheader-order <list>",
   "Change the order of WebSocket headers",
   CURLHELP_HTTP},
  {"    --ws-cert-compression <algorithm list>",
   "WebSocket TLS certificate compression",
   CURLHELP_TLS},
  {"    --ws-disable-session-ticket",
   "Disable WebSocket TLS session ticket extension",
   CURLHELP_TLS},
  {"    --tlsauthtype <type>",

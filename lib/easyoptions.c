...
const struct curl_easyoption Curl_easyopts[] = {
  ...
  {"HTTP3_HTTPHEADER", CURLOPT_HTTP3_HTTPHEADER, CURLOT_SLIST, 0},
  {"HTTP3_HTTPHEADER_ORDER", CURLOPT_HTTP3_HTTPHEADER_ORDER, CURLOT_STRING, 0},
  ...
  {"HTTP3_SIG_HASH_ALGS", CURLOPT_HTTP3_SIG_HASH_ALGS, CURLOT_STRING, 0},
  {"HTTP3_SSL_EC_CURVES", CURLOPT_HTTP3_SSL_EC_CURVES, CURLOT_STRING, 0},
  {"HTTP3_TLS_EXTENSION_ORDER", CURLOPT_HTTP3_TLS_EXTENSION_ORDER, CURLOT_STRING, 0},
  ...
  {"WS_HTTPHEADER", CURLOPT_WS_HTTPHEADER, CURLOT_SLIST, 0},
  {"WS_HTTPHEADER_ORDER", CURLOPT_WS_HTTPHEADER_ORDER, CURLOT_STRING, 0},
  {"WS_OPTIONS", CURLOPT_WS_OPTIONS, CURLOT_LONG, 0},
  {"WS_SSL_CERT_COMPRESSION", CURLOPT_WS_SSL_CERT_COMPRESSION, CURLOT_STRING, 0},
  {"WS_SSL_DISABLE_TICKET", CURLOPT_WS_SSL_DISABLE_TICKET, CURLOT_LONG, 0},
